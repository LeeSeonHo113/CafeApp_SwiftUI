...
let names3: Array<String> = [
    ...
    "망고요거트스무디",
    "딸기요거트스무"]
let prices3: Array<String> = ["HOT : 3,000\nICED : 3,500",
                               "ICED : 3,500",
                               "ICED : 3,500",
                               "HOT : 3,000\nICED : 3,500",
                               "HOT : 3,000\nICED : 3,000",
...
let images3: Array<String> = ["http://paikdabang.com/wp-content/uploads/2018/05/%EC%99%84%EC%A0%84%EC%B4%88%EC%BD%94.jpg",
...
let messages3: Array<String> = ["초코에 퐁당 빠지고 싶을때~!? 진짜~! 다크초콜렛이 올라간 완~전 진한 초코라떼",
...
struct Menu3View: View {
    ...
    var body: some View {
        ...
        var index = 0;
        for _ in names {
            let menu: Menu = Menu(name: names3[index], price: prices3[index], imageUrl: images3[index],
                                  message: messages3[index])
